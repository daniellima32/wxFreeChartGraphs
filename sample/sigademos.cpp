...
/**
 * SigaDemo1: Multiple axis demo.
 */
//class MultipleAxisDemo2 : public ChartDemo
class SigaDemo1A : public ChartDemo
{
public:
	SigaDemo1A()
    : ChartDemo(wxT("Siga Demo - Multiple axis 1"))
    {
    }
...
class SigaDemo1B : public ChartDemo
{
public:
	SigaDemo1B()
...
*/
class SigaDemo1C : public ChartDemo
{
public:
	SigaDemo1C()
...
int sigaDemosCount = WXSIZEOF(sigaDemos);
